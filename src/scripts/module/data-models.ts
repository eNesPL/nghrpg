...
const BaseTypeDataModel = foundry.abstract.TypeDataModel as unknown as new (...args: any[]) => any;

const createTrackedAttribute = (initial: number) => {
...
export const NGHActorDataModels: Record<string, any> = {
  character: NGHCharacterDataModel,
  npc: NGHNPCDataModel
};

export const NGHItemDataModels: Record<string, any> = {
